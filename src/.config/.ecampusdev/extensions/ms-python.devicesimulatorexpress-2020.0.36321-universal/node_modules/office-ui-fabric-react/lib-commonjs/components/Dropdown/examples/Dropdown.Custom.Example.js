...
var DropdownCustomExample = /** @class */ (function (_super) {
    ...
    DropdownCustomExample.prototype.render = function () {
        return (React.createElement(Stack_1.Stack, { tokens: stackTokens },
            ...
            React.createElement(Dropdown_1.Dropdown, { placeholder: "Select an option", label: "Custom label", ariaLabel: "Custom dropdown label example", styles: { dropdown: { width: 300 } }, options: exampleOptions, onRenderLabel: this._onRenderLabel })));
    };
