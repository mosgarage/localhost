define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/GroupedList", "office-ui-fabric-react/lib/Link", "@uifabric/example-data", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, GroupedList_1, Link_1, example_data_1, Styling_1) {
    "use strict";
    ...
    var GroupedListCustomExample = /** @class */ (function (_super) {
        ...
        function GroupedListCustomExample() {
            ...
            _this._items = example_data_1.createListItems(20);
            _this._groups = example_data_1.createGroups(4, 0, 0, 5);
            return _this;
        }
