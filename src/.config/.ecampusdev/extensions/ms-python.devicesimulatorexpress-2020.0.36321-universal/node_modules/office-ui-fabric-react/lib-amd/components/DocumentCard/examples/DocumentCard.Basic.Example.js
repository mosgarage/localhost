define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DocumentCard", "office-ui-fabric-react/lib/Image", "@uifabric/example-data"], function (require, exports, tslib_1, React, DocumentCard_1, Image_1, example_data_1) {
    ...
    var DocumentCardBasicExample = /** @class */ (function (_super) {
        ...
        DocumentCardBasicExample.prototype.render = function () {
            ...
            return (React.createElement(DocumentCard_1.DocumentCard, { "aria-label": "Default Document Card with large file name. Created by Annie Lindqvist a few minutes ago.", onClickHref: "http://bing.com" },
                ...
                React.createElement(DocumentCard_1.DocumentCardActivity, { activity: "Created a few minutes ago", people: [{ name: 'Annie Lindqvist', profileImageSrc: example_data_1.TestImages.personaFemale }] })));
        };
