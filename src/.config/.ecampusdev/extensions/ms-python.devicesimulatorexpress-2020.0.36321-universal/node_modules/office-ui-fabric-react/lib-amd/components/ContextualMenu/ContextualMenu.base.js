        ...
        function ContextualMenuBase(props) {
            ...
            _this._onRenderMenuList = function (menuListProps, defaultRender) {
                ...
                return (React.createElement("ul", { className: _this._classNames.list, onKeyDown: _this._onKeyDown, onKeyUp: _this._onKeyUp, role: "menu" }, menuListProps.items.map(function (item, index) {
                    var menuItem = _this._renderMenuItem(tslib_1.__assign(tslib_1.__assign({}, item), { index: index, focusableElementIndex: indexCorrection, totalItemCount: menuListProps.totalItemCount, hasCheckmarks: menuListProps.hasCheckmarks, hasIcons: menuListProps.hasIcons }));
                    ...
                    React.createElement("div", tslib_1.__assign({}, groupProps),
                        React.createElement("ul", { className: this._classNames.list },
                            ...
                            sectionProps.items.map(function (contextualMenuItem, itemsIndex) {
                                return _this._renderMenuItem(tslib_1.__assign(tslib_1.__assign({}, contextualMenuItem), { index: itemsIndex, focusableElementIndex: itemsIndex, totalItemCount: sectionProps.items.length, hasCheckmarks: hasCheckmarks,
                                    hasIcons: hasIcons }));
                            }),
