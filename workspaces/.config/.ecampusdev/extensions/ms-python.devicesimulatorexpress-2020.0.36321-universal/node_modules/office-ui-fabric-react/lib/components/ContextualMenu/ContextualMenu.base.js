...
import { divProperties, getNativeProps, shallowCompare, warnDeprecations, Async, EventGroup, assign, classNamesFunction, css, getDocument, getFirstFocusable, getId, getLastFocusable, getRTL, getWindow, KeyCodes, shouldWrapFocus, isIOS, isMac, initializeComponentRef, } from '../../Utilities';
    ...
    function ContextualMenuBase(props) {
        ...
        _this._onRenderMenuList = function (menuListProps, defaultRender) {
            ...
            return (React.createElement("ul", { className: _this._classNames.list, onKeyDown: _this._onKeyDown, onKeyUp: _this._onKeyUp, role: "menu" }, menuListProps.items.map(function (item, index) {
                var menuItem = _this._renderMenuItem(__assign(__assign({}, item), { index: index, focusableElementIndex: indexCorrection, totalItemCount: menuListProps.totalItemCount, hasCheckmarks: menuListProps.hasCheckmarks, hasIcons: menuListProps.hasIcons }));
        ...
        _this._renderMenuItem = function (item) {
            var renderedItems = [];
            var iconProps = item.iconProps || { iconName: 'None' };
            var getItemClassNames = item.getItemClassNames, // tslint:disable-line:deprecation
            itemProps = item.itemProps, index = item.index, focusableElementIndex = item.focusableElementIndex, totalItemCount = item.totalItemCount, hasCheckmarks = item.hasCheckmarks, hasIcons = item.hasIcons;
            ...
            if (getItemClassNames) {
                ...
                var menuItemStyles = _this._classNames.subComponentStyles
                    ? _this._classNames.subComponentStyles.menuItem
                    : undefined;
                ...
                React.createElement("div", __assign({}, groupProps),
                    React.createElement("ul", { className: this._classNames.list },
                        ...
                        sectionProps.items.map(function (contextualMenuItem, itemsIndex) {
                            return _this._renderMenuItem(__assign(__assign({}, contextualMenuItem), { index: itemsIndex, focusableElementIndex: itemsIndex, totalItemCount: sectionProps.items.length, hasCheckmarks: hasCheckmarks,
                                hasIcons: hasIcons }));
                        }),
