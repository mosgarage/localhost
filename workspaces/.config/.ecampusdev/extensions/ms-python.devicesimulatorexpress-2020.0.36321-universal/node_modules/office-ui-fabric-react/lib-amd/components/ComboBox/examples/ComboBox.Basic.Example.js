    ...
    var ComboBoxBasicExample = /** @class */ (function (_super) {
        ...
        ComboBoxBasicExample.prototype.render = function () {
            ...
            return (React.createElement(index_1.Fabric, { className: wrapperClassName },
                ...
                React.createElement(index_1.ComboBox, { label: "ComboBox with static error message", defaultSelectedKey: "B", errorMessage: "Oh no! This ComboBox has an error!", options: INITIAL_OPTIONS }),
                React.createElement(index_1.ComboBox, { label: "ComboBox with dynamic error message", onChange: this._onChange, selectedKey: this.state.dynamicErrorValue, errorMessage: this._getErrorMessage(this.state.dynamicErrorValue), options: INITIAL_OPTIONS }),
