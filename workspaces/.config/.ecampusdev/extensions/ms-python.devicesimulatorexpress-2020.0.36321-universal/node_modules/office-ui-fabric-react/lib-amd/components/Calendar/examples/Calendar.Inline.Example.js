define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/utilities/dateMath/DateMath", "office-ui-fabric-react/lib/Calendar"], function (require, exports, tslib_1, React, Button_1, DateMath_1, Calendar_1) {
    "use strict";
    ...
    var CalendarInlineExample = /** @class */ (function (_super) {
                ...
                this.props.restrictedDates && (React.createElement("div", null,
                    ...
                    React.createElement("span", null,
                        ...
                        this.props.restrictedDates.length > 0
                            ? this.props.restrictedDates.map(function (d) { return d.toLocaleDateString(); }).join(', ')
                            : 'Not set'))),
        ...
        CalendarInlineExample.prototype._goPrevious = function () {
            ...
            this.setState(function (prevState) {
                ...
                if (_this.props.dateRangeType === Calendar_1.DateRangeType.Month) {
