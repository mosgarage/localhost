define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DocumentCard", "office-ui-fabric-react/lib/Image", "@uifabric/example-data"], function (require, exports, tslib_1, React, DocumentCard_1, Image_1, example_data_1) {
    ...
    var DocumentCardCompleteExample = /** @class */ (function (_super) {
        ...
        DocumentCardCompleteExample.prototype.render = function () {
            ...
            return (React.createElement(DocumentCard_1.DocumentCard, { "aria-label": "Document Card with multiple items, commands and views. Marketing documents. 6 files were uploaded.\n        Created by Annie Lindqvist in February 23, 2016. 432 views.", onClick: this._onClick },
