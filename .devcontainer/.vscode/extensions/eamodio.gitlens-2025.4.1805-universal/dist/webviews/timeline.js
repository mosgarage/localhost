...
`;var tq=Object.defineProperty,tW=Object.getOwnPropertyDescriptor,tG=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?tW(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&tq(t,i,s),s};let tV=class extends GlElement{constructor(){super(...arguments),this._authors=new Map,this._authorsByIndex=new Map,this._commitsByTimestamp=new Map,this.placement="editor",this._data=null,this.zoomed=!1,this.onDataPointClicked=(e,t)=>{let i=this._commitsByTimestamp.get(new Date(e.x).toISOString());null!=i&&this.emit("gl-data-point-click",{data:{id:i.commit,selected:!0}})},this.onResize=e=>{this._chart?.resize({width:e[0].contentRect.width,height:e[0].contentRect.height})}}get compact(){return"editor"!==this.placement}get data(){return this._data}get dataPromise(){return this._dataPromise}set dataPromise(e){this._dataPromise!==e&&(this._dataPromise=e,this._dataPromise?.then(e=>this._data=e,()=>this._data=void 0))}connectedCallback(){super.connectedCallback(),this._resizeObserver=new ResizeObserver(this.onResize),this._resizeObserver?.observe(this,{box:"border-box"})}disconnectedCallback(){this._resizeObserver?.disconnect(),this._resizeObserver=void 0,this._loading?.cancel(),this._chart?.destroy(),this._chart=void 0,super.disconnectedCallback()}update(e){e.has("zoomed")&&this.emit("gl-zoomed",this.zoomed),e.has("dataPromise")&&(this._abortController?.abort(),this._abortController=new AbortController,this._loading?.cancel(),this.updateChart(this.dataPromise)),super.update(e)}render(){return null===this.data?ew:this.data?.length?ev`<div id="chart"></div>`:ev`<div class="empty"><p>No commits found for the specified time period.</p></div>`}reset(){this._chart?.unzoom(),this.zoomed=!1}zoom(e){if(!this._chart)return;let t=this._chart.zoom(),i=[new Date(t[0]),new Date(t[1])],o=i[1].getTime()-i[0].getTime(),r=new Date((i[1].getTime()+i[0].getTime())/2),s=new Date(r.getTime()-o*(1-e)/2),a=new Date(r.getTime()+o*(1-e)/2),l=this._chart.zoom([s,a]);e<0&&l[0]===t[0]&&l[1]===t[1]&&(this._chart.unzoom(),this.zoomed=!1)}async updateChart(i){if(this._loading?.pending)return;let o=this._abortController,r=function(){let e={pending:!0,promise:void 0,fulfill:void 0,cancel:void 0};return e.promise=new Promise((t,i)=>{e.fulfill=function(i){e.pending=!1,t(i)},e.cancel=function(t){e.pending=!1,null!=t?i(t):i()}}),e}();this._loading=r,r.promise.then(()=>this.emit("gl-load"),()=>{});let s=await i;if(o?.signal.aborted)return void r?.cancel();if(!s?.length){this._chart?.destroy(),this._chart=void 0,r?.fulfill();return}this._authors.clear(),this._authorsByIndex.clear(),this._commitsByTimestamp.clear();let a={minRadius:6,maxRadius:50,...this.calculateChangeMetrics(s)},{bb:l,bar:c,scatter:d,selection:h,zoom:p}=await w.e(162).then(w.bind(w,667));if(o?.signal.aborted)return void r?.cancel();this._originalDomain=[new Date(s[s.length-1].date),new Date(s[0].date)],c(),d();let u=this.prepareChartData(s,a);try{let i=-(this._authors.size+1),o=[...this._authorsByIndex.keys()];if(null==this._chart){let s={bindto:this.chartContainer,onafterinit:()=>setTimeout(()=>r?.fulfill(),250),onrendered:this.compact?this.getOnRenderedCallback(this):void 0,onresized:()=>{null!=this._chart&&null!=this._zoomedDomain&&this._chart.zoom(this._zoomedDomain)},clipPath:!0,data:{...u,colors:{additions:"rgba(73, 190, 71, 1)",deletions:"rgba(195, 32, 45, 1)"},groups:[["additions","deletions"]],selection:{enabled:h(),draggable:!1,grouped:!0,multiple:!1,isselectable:()=>!1},onclick:this.onDataPointClicked},axis:{x:{type:"timeseries",localtime:!0,height:this.compact?28:void 0,forceAsSingle:!0,tick:{fit:!1,format:e=>"number"==typeof e?e:eq(e,this.shortDateFormat??"short"),outer:!0}},y:{max:0,min:i,padding:{top:75,bottom:75},tick:{format:e=>this.compact?"":this._authorsByIndex.get(e)??"",outer:!0,values:o}},y2:{padding:this.compact?{top:0,bottom:0}:void 0,label:this.compact?void 0:{text:"Lines changed",position:"outer-middle"},show:!0,tick:{format:e=>this.compact?"":e,outer:!0}}},bar:{width:2,sensitivity:4,padding:2},scatter:{zerobased:!0},grid:{focus:{edge:!0,show:!0,y:!0},front:!1,lines:{front:!1},x:{show:!1},y:{show:!0}},legend:{show:!0,hide:["additions","deletions"],padding:4,item:{tile:{type:"circle",r:4},interaction:{dblclick:!0}},tooltip:!0},point:{r:e=>null==e||"function"==typeof e.data&&(e=e.data()[0],null==e)?0:null!=e.r?e.r:Math.max(6,this._authors.get(e.id)?.z.get(e.x.toISOString())??6),focus:{expand:{enabled:!0}},select:{r:6}},resize:{auto:!1},tooltip:{contents:(i,o,r,s)=>{var a;let l=i[0],c=new Date(l.x),d=this._commitsByTimestamp.get(c.toISOString());if(null==d)return"";let h=d.additions,p=d.deletions,u=null==h?"":`<span class="additions">+${tf("line",h)}</span>`,b=null==p?"":`<span class="deletions">-${tf("line",p)}</span>`;return u&&(b=`, ${b}`),`<div class="bb-tooltip">
							...
							</div>`},show:!0},zoom:{enabled:p(),type:"wheel",extent:[1,.01],onzoom:e=>{new Date(e[0])<=this._originalDomain[0]&&new Date(e[1])>=this._originalDomain[1]?(this._zoomedDomain=void 0,this.zoomed=!1):(this._zoomedDomain=e,this.zoomed=!0)},onzoomend:e=>{new Date(e[0])<=this._originalDomain[0]&&new Date(e[1])>=this._originalDomain[1]?(this._zoomedDomain=void 0,this.zoomed=!1):(this._zoomedDomain=e,this.zoomed=!0)}}};this._chart=l.generate(s)}else this._chart.config("axis.y.tick.values",o,!1),this._chart.config("axis.y.min",i,!1),this._chart.load({...u,resizeAfter:!0,unload:!0,done:()=>setTimeout(()=>r?.fulfill(),250)});return void await r.promise.catch(()=>{})}catch(e){r?.cancel()}}prepareChartData(e,t){let i=e.length+1,o=Array(i);o[0]="time";let r=Array(i);r[0]="additions";let s=Array(i);s[0]="deletions";let a={time:"x",additions:"y2",deletions:"y2"},l={additions:"bar",deletions:"bar"},c={additions:"time",deletions:"time"},d=0,h=0;for(let i of e){let{author:e,date:p,additions:u=0,deletions:b=0}=i;this._commitsByTimestamp.set(p,i),o[++h]=p,r[h]=u,s[h]=b;let f=this.calculateBubbleSize(u+b,t),g=this._authors.get(e);null==g?(g={x:[`time.${e}`,p],y:d,z:new Map([[p,f]])},this._authors.set(e,g),this._authorsByIndex.set(d,e),a[e]="y",l[e]="scatter",c[e]=`time.${e}`,d--):(g.x.push(p),g.z.set(p,f))}let p=[o,r,s];for(let[e,t]of this._authors){p.push(t.x);let i=Array(t.x.length).fill(t.y);i[0]=e,p.push(i)}return{axes:a,columns:p,names:{additions:"Additions",deletions:"Deletions"},types:l,xs:c}}calculateChangeMetrics(e){let t=e.map(e=>(e.additions??0)+(e.deletions??0)).sort((e,t)=>e-t);return{maxChanges:t[t.length-1],q1:t[Math.floor(.25*t.length)],q3:t[Math.floor(.75*t.length)]}}calculateBubbleSize(e,{minRadius:t,maxRadius:i,q1:o,q3:r,maxChanges:s}){let a;return 0===e?t:(a=e<=o?t+e/o*10:e<=r?t+10+(e-o)/(r-o)*15:t+25+Math.log(e-r+1)/Math.log(s-r+1)*15,Math.max(t,Math.min(i,a)))}getOnRenderedCallback(e){return function(){let t=this;null!=t&&t.$.main.selectAll(".bb-axis-y .tick text tspan").each(function(i){if(this==null)return;let o=e._authorsByIndex.get(-i.index),r=t.color(o);this.setAttribute("fill",r);let s=document.createElementNS("http://www.w3.org/2000/svg","title");s.textContent=o,this.appendChild(s)})}}};tV.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},tV.styles=[tH],tG([eM("#chart")],tV.prototype,"chartContainer",2),tG([eL()],tV.prototype,"placement",2),tG([eL()],tV.prototype,"dateFormat",2),tG([eL()],tV.prototype,"shortDateFormat",2),tG([eT()],tV.prototype,"_data",2),tG([eL({type:Boolean,reflect:!0})],tV.prototype,"zoomed",2),tG([eL({type:Object})],tV.prototype,"dataPromise",1),tG([tm({args:!1})],tV.prototype,"updateChart",1),tG([tm({args:{0:e=>e?.length}})],tV.prototype,"prepareChartData",1),tV=tG([ez("gl-timeline-chart")],tV);let tY=e=>e??ew;function tK(e,t){return null==t?`command:${e}`:`command:${e}?${encodeURIComponent("string"==typeof t?t:JSON.stringify(t))}`}let tZ=A`
	a {
		border: 0;
...
`,iS=class extends lit_element_i{constructor(){super(),il(this,g,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let i=new CustomEvent(e,ii({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(i),i}static define(e,t=this,i={}){let o=customElements.get(e);if(!o){try{customElements.define(e,t,i)}catch(o){customElements.define(e,class extends t{},i)}return}let r=" (unknown version)",s=r;if("version"in t&&t.version&&(r=" v"+t.version),"version"in o&&o.version&&(s=" v"+o.version),r&&s&&r===s)return}attributeChangedCallback(e,t,i){ia(this,g)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&null!=this[t]&&this.initialReflectedProperties.set(t,this[t])}),ic(this,g,!0)),super.attributeChangedCallback(e,t,i)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,i)=>{e.has(i)&&null==this[i]&&(this[i]=t)})}};g=new WeakMap,iS.version="2.20.1",iS.dependencies={},ir([eL()],iS.prototype,"dir",2),ir([eL()],iS.prototype,"lang",2);let iE=Math.min,iz=Math.max,iO=Math.round,iD=Math.floor,iL=e=>({x:e,y:e}),iT={left:"right",right:"left",bottom:"top",top:"bottom"},iR={start:"end",end:"start"};function iM(e,t){return"function"==typeof e?e(t):e}function iB(e){return e.split("-")[0]}function iN(e){return e.split("-")[1]}function iU(e){return"x"===e?"y":"x"}function ij(e){return"y"===e?"height":"width"}function iF(e){return["top","bottom"].includes(iB(e))?"y":"x"}function iI(e){return e.replace(/start|end/g,e=>iR[e])}function iH(e){return e.replace(/left|right|bottom|top/g,e=>iT[e])}function iq(e){return"number"!=typeof e?{top:0,right:0,bottom:0,left:0,...e}:{top:e,right:e,bottom:e,left:e}}function iW(e){let{x:t,y:i,width:o,height:r}=e;return{width:o,height:r,top:i,left:t,right:t+o,bottom:i+r,x:t,y:i}}function iG(e,t,i){let o,{reference:r,floating:s}=e,a=iF(t),l=iU(iF(t)),c=ij(l),d=iB(t),h="y"===a,p=r.x+r.width/2-s.width/2,u=r.y+r.height/2-s.height/2,b=r[c]/2-s[c]/2;switch(d){case"top":o={x:p,y:r.y-s.height};break;case"bottom":o={x:p,y:r.y+r.height};break;case"right":o={x:r.x+r.width,y:u};break;case"left":o={x:r.x-s.width,y:u};break;default:o={x:r.x,y:r.y}}switch(iN(t)){case"start":o[l]-=b*(i&&h?-1:1);break;case"end":o[l]+=b*(i&&h?-1:1)}return o}let iV=async(e,t,i)=>{let{placement:o="bottom",strategy:r="absolute",middleware:s=[],platform:a}=i,l=s.filter(Boolean),c=await (null==a.isRTL?void 0:a.isRTL(t)),d=await a.getElementRects({reference:e,floating:t,strategy:r}),{x:h,y:p}=iG(d,o,c),u=o,b={},f=0;for(let i=0;i<l.length;i++){let{name:s,fn:g}=l[i],{x:m,y:v,data:w,reset:_}=await g({x:h,y:p,initialPlacement:o,placement:u,strategy:r,middlewareData:b,rects:d,platform:a,elements:{reference:e,floating:t}});h=null!=m?m:h,p=null!=v?v:p,b={...b,[s]:{...b[s],...w}},_&&f<=50&&(f++,"object"==typeof _&&(_.placement&&(u=_.placement),_.rects&&(d=!0===_.rects?await a.getElementRects({reference:e,floating:t,strategy:r}):_.rects),{x:h,y:p}=iG(d,u,c)),i=-1)}return{x:h,y:p,placement:u,strategy:r,middlewareData:b}};async function iY(e,t){var i;void 0===t&&(t={});let{x:o,y:r,platform:s,rects:a,elements:l,strategy:c}=e,{boundary:d="clippingAncestors",rootBoundary:h="viewport",elementContext:p="floating",altBoundary:u=!1,padding:b=0}=iM(t,e),f=iq(b),g=l[u?"floating"===p?"reference":"floating":p],m=iW(await s.getClippingRect({element:null==(i=await (null==s.isElement?void 0:s.isElement(g)))||i?g:g.contextElement||await (null==s.getDocumentElement?void 0:s.getDocumentElement(l.floating)),boundary:d,rootBoundary:h,strategy:c})),v="floating"===p?{x:o,y:r,width:a.floating.width,height:a.floating.height}:a.reference,w=await (null==s.getOffsetParent?void 0:s.getOffsetParent(l.floating)),_=await (null==s.isElement?void 0:s.isElement(w))&&await (null==s.getScale?void 0:s.getScale(w))||{x:1,y:1},x=iW(s.convertOffsetParentRelativeRectToViewportRelativeRect?await s.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:v,offsetParent:w,strategy:c}):v);return{top:(m.top-x.top+f.top)/_.y,bottom:(x.bottom-m.bottom+f.bottom)/_.y,left:(m.left-x.left+f.left)/_.x,right:(x.right-m.right+f.right)/_.x}}async function iK(e,t){let{placement:i,platform:o,elements:r}=e,s=await (null==o.isRTL?void 0:o.isRTL(r.floating)),a=iB(i),l=iN(i),c="y"===iF(i),d=["left","top"].includes(a)?-1:1,h=s&&c?-1:1,p=iM(t,e),{mainAxis:u,crossAxis:b,alignmentAxis:f}="number"==typeof p?{mainAxis:p,crossAxis:0,alignmentAxis:null}:{mainAxis:p.mainAxis||0,crossAxis:p.crossAxis||0,alignmentAxis:p.alignmentAxis};return l&&"number"==typeof f&&(b="end"===l?-1*f:f),c?{x:b*h,y:u*d}:{x:u*d,y:b*h}}function iZ(){return"undefined"!=typeof window}function iX(e){return i0(e)?(e.nodeName||"").toLowerCase():"#document"}function iQ(e){var t;return(null==e||null==(t=e.ownerDocument)?void 0:t.defaultView)||window}function iJ(e){var t;return null==(t=(i0(e)?e.ownerDocument:e.document)||window.document)?void 0:t.documentElement}function i0(e){return!!iZ()&&(e instanceof Node||e instanceof iQ(e).Node)}function i1(e){return!!iZ()&&(e instanceof Element||e instanceof iQ(e).Element)}function i2(e){return!!iZ()&&(e instanceof HTMLElement||e instanceof iQ(e).HTMLElement)}function i8(e){return!!iZ()&&"undefined"!=typeof ShadowRoot&&(e instanceof ShadowRoot||e instanceof iQ(e).ShadowRoot)}function i5(e){let{overflow:t,overflowX:i,overflowY:o,display:r}=i4(e);return/auto|scroll|overlay|hidden|clip/.test(t+o+i)&&!["inline","contents"].includes(r)}function i9(e){return[":popover-open",":modal"].some(t=>{try{return e.matches(t)}catch{return!1}})}function i6(e){let t=i3(),i=i1(e)?i4(e):e;return["transform","translate","scale","rotate","perspective"].some(e=>!!i[e]&&"none"!==i[e])||!!i.containerType&&"normal"!==i.containerType||!t&&!!i.backdropFilter&&"none"!==i.backdropFilter||!t&&!!i.filter&&"none"!==i.filter||["transform","translate","scale","rotate","perspective","filter"].some(e=>(i.willChange||"").includes(e))||["paint","layout","strict","content"].some(e=>(i.contain||"").includes(e))}function i3(){return"undefined"!=typeof CSS&&!!CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")}function i7(e){return["html","body","#document"].includes(iX(e))}function i4(e){return iQ(e).getComputedStyle(e)}function oe(e){return i1(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function ot(e){if("html"===iX(e))return e;let t=e.assignedSlot||e.parentNode||i8(e)&&e.host||iJ(e);return i8(t)?t.host:t}function oi(e,t,i){var o;void 0===t&&(t=[]),void 0===i&&(i=!0);let r=function e(t){let i=ot(t);return i7(i)?t.ownerDocument?t.ownerDocument.body:t.body:i2(i)&&i5(i)?i:e(i)}(e),s=r===(null==(o=e.ownerDocument)?void 0:o.body),a=iQ(r);if(s){let e=oo(a);return t.concat(a,a.visualViewport||[],i5(r)?r:[],e&&i?oi(e):[])}return t.concat(r,oi(r,[],i))}function oo(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function or(e){let t=i4(e),i=parseFloat(t.width)||0,o=parseFloat(t.height)||0,r=i2(e),s=r?e.offsetWidth:i,a=r?e.offsetHeight:o,l=iO(i)!==s||iO(o)!==a;return l&&(i=s,o=a),{width:i,height:o,$:l}}function os(e){return i1(e)?e:e.contextElement}function on(e){let t=os(e);if(!i2(t))return iL(1);let i=t.getBoundingClientRect(),{width:o,height:r,$:s}=or(t),a=(s?iO(i.width):i.width)/o,l=(s?iO(i.height):i.height)/r;return a&&Number.isFinite(a)||(a=1),l&&Number.isFinite(l)||(l=1),{x:a,y:l}}let oa=iL(0);function ol(e){let t=iQ(e);return i3()&&t.visualViewport?{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}:oa}function oc(e,t,i,o){var r;void 0===t&&(t=!1),void 0===i&&(i=!1);let s=e.getBoundingClientRect(),a=os(e),l=iL(1);t&&(o?i1(o)&&(l=on(o)):l=on(e));let c=(void 0===(r=i)&&(r=!1),o&&(!r||o===iQ(a))&&r)?ol(a):iL(0),d=(s.left+c.x)/l.x,h=(s.top+c.y)/l.y,p=s.width/l.x,u=s.height/l.y;if(a){let e=iQ(a),t=o&&i1(o)?iQ(o):o,i=e,r=oo(i);for(;r&&o&&t!==i;){let e=on(r),t=r.getBoundingClientRect(),o=i4(r),s=t.left+(r.clientLeft+parseFloat(o.paddingLeft))*e.x,a=t.top+(r.clientTop+parseFloat(o.paddingTop))*e.y;d*=e.x,h*=e.y,p*=e.x,u*=e.y,d+=s,h+=a,r=oo(i=iQ(r))}}return iW({width:p,height:u,x:d,y:h})}function od(e,t){let i=oe(e).scrollLeft;return t?t.left+i:oc(iJ(e)).left+i}function oh(e,t,i){void 0===i&&(i=!1);let o=e.getBoundingClientRect();return{x:o.left+t.scrollLeft-(i?0:od(e,o)),y:o.top+t.scrollTop}}function op(e,t,i){let o;if("viewport"===t)o=function(e,t){let i=iQ(e),o=iJ(e),r=i.visualViewport,s=o.clientWidth,a=o.clientHeight,l=0,c=0;if(r){s=r.width,a=r.height;let e=i3();(!e||e&&"fixed"===t)&&(l=r.offsetLeft,c=r.offsetTop)}return{width:s,height:a,x:l,y:c}}(e,i);else if("document"===t)o=function(e){let t=iJ(e),i=oe(e),o=e.ownerDocument.body,r=iz(t.scrollWidth,t.clientWidth,o.scrollWidth,o.clientWidth),s=iz(t.scrollHeight,t.clientHeight,o.scrollHeight,o.clientHeight),a=-i.scrollLeft+od(e),l=-i.scrollTop;return"rtl"===i4(o).direction&&(a+=iz(t.clientWidth,o.clientWidth)-r),{width:r,height:s,x:a,y:l}}(iJ(e));else if(i1(t))o=function(e,t){let i=oc(e,!0,"fixed"===t),o=i.top+e.clientTop,r=i.left+e.clientLeft,s=i2(e)?on(e):iL(1),a=e.clientWidth*s.x,l=e.clientHeight*s.y;return{width:a,height:l,x:r*s.x,y:o*s.y}}(t,i);else{let i=ol(e);o={x:t.x-i.x,y:t.y-i.y,width:t.width,height:t.height}}return iW(o)}function ou(e){return"static"===i4(e).position}function ob(e,t){if(!i2(e)||"fixed"===i4(e).position)return null;if(t)return t(e);let i=e.offsetParent;return iJ(e)===i&&(i=i.ownerDocument.body),i}function of(e,t){let i=iQ(e);if(i9(e))return i;if(!i2(e)){let t=ot(e);for(;t&&!i7(t);){if(i1(t)&&!ou(t))return t;t=ot(t)}return i}let o=ob(e,t);for(;o&&["table","td","th"].includes(iX(o))&&ou(o);)o=ob(o,t);return o&&i7(o)&&ou(o)&&!i6(o)?i:o||function(e){let t=ot(e);for(;i2(t)&&!i7(t);){if(i6(t))return t;if(i9(t))break;t=ot(t)}return null}(e)||i}let og=async function(e){let t=this.getOffsetParent||of,i=this.getDimensions,o=await i(e.floating);return{reference:function(e,t,i){let o=i2(t),r=iJ(t),s="fixed"===i,a=oc(e,!0,s,t),l={scrollLeft:0,scrollTop:0},c=iL(0);if(o||!o&&!s)if(("body"!==iX(t)||i5(r))&&(l=oe(t)),o){let e=oc(t,!0,s,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else r&&(c.x=od(r));let d=!r||o||s?iL(0):oh(r,l);return{x:a.left+l.scrollLeft-c.x-d.x,y:a.top+l.scrollTop-c.y-d.y,width:a.width,height:a.height}}(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:o.width,height:o.height}}},om={convertOffsetParentRelativeRectToViewportRelativeRect:function(e){let{elements:t,rect:i,offsetParent:o,strategy:r}=e,s="fixed"===r,a=iJ(o),l=!!t&&i9(t.floating);if(o===a||l&&s)return i;let c={scrollLeft:0,scrollTop:0},d=iL(1),h=iL(0),p=i2(o);if((p||!p&&!s)&&(("body"!==iX(o)||i5(a))&&(c=oe(o)),i2(o))){let e=oc(o);d=on(o),h.x=e.x+o.clientLeft,h.y=e.y+o.clientTop}let u=!a||p||s?iL(0):oh(a,c,!0);return{width:i.width*d.x,height:i.height*d.y,x:i.x*d.x-c.scrollLeft*d.x+h.x+u.x,y:i.y*d.y-c.scrollTop*d.y+h.y+u.y}},getDocumentElement:iJ,getClippingRect:function(e){let{element:t,boundary:i,rootBoundary:o,strategy:r}=e,s=[..."clippingAncestors"===i?i9(t)?[]:function(e,t){let i=t.get(e);if(i)return i;let o=oi(e,[],!1).filter(e=>i1(e)&&"body"!==iX(e)),r=null,s="fixed"===i4(e).position,a=s?ot(e):e;for(;i1(a)&&!i7(a);){let t=i4(a),i=i6(a);i||"fixed"!==t.position||(r=null),(s?!i&&!r:!i&&"static"===t.position&&!!r&&["absolute","fixed"].includes(r.position)||i5(a)&&!i&&function e(t,i){let o=ot(t);return!(o===i||!i1(o)||i7(o))&&("fixed"===i4(o).position||e(o,i))}(e,a))?o=o.filter(e=>e!==a):r=t,a=ot(a)}return t.set(e,o),o}(t,this._c):[].concat(i),o],a=s[0],l=s.reduce((e,i)=>{let o=op(t,i,r);return e.top=iz(o.top,e.top),e.right=iE(o.right,e.right),e.bottom=iE(o.bottom,e.bottom),e.left=iz(o.left,e.left),e},op(t,a,r));return{width:l.right-l.left,height:l.bottom-l.top,x:l.left,y:l.top}},getOffsetParent:of,getElementRects:og,getClientRects:function(e){return Array.from(e.getClientRects())},getDimensions:function(e){let{width:t,height:i}=or(e);return{width:t,height:i}},getScale:on,isElement:i1,isRTL:function(e){return"rtl"===i4(e).direction}};function ov(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}let oy=function(e){return void 0===e&&(e={}),{name:"size",options:e,async fn(t){var i,o;let r,s,{placement:a,rects:l,platform:c,elements:d}=t,{apply:h=()=>{},...p}=iM(e,t),u=await iY(t,p),b=iB(a),f=iN(a),g="y"===iF(a),{width:m,height:v}=l.floating;"top"===b||"bottom"===b?(r=b,s=f===(await (null==c.isRTL?void 0:c.isRTL(d.floating))?"start":"end")?"left":"right"):(s=b,r="end"===f?"top":"bottom");let w=v-u.top-u.bottom,_=m-u.left-u.right,x=iE(v-u[r],w),$=iE(m-u[s],_),P=!t.middlewareData.shift,C=x,A=$;if(null!=(i=t.middlewareData.shift)&&i.enabled.x&&(A=_),null!=(o=t.middlewareData.shift)&&o.enabled.y&&(C=w),P&&!f){let e=iz(u.left,0),t=iz(u.right,0),i=iz(u.top,0),o=iz(u.bottom,0);g?A=m-2*(0!==e||0!==t?e+t:iz(u.left,u.right)):C=v-2*(0!==i||0!==o?i+o:iz(u.top,u.bottom))}await h({...t,availableWidth:A,availableHeight:C});let S=await c.getDimensions(d.floating);return m!==S.width||v!==S.height?{reset:{rects:!0}}:{}}}},ow=e=>({name:"arrow",options:e,async fn(t){let{x:i,y:o,placement:r,rects:s,platform:a,elements:l,middlewareData:c}=t,{element:d,padding:h=0}=iM(e,t)||{};if(null==d)return{};let p=iq(h),u={x:i,y:o},b=iU(iF(r)),f=ij(b),g=await a.getDimensions(d),m="y"===b,v=m?"clientHeight":"clientWidth",w=s.reference[f]+s.reference[b]-u[b]-s.floating[f],_=u[b]-s.reference[b],x=await (null==a.getOffsetParent?void 0:a.getOffsetParent(d)),$=x?x[v]:0;$&&await (null==a.isElement?void 0:a.isElement(x))||($=l.floating[v]||s.floating[f]);let P=$/2-g[f]/2-1,C=iE(p[m?"top":"left"],P),A=iE(p[m?"bottom":"right"],P),S=$-g[f]-A,E=$/2-g[f]/2+(w/2-_/2),O=iz(C,iE(E,S)),D=!c.arrow&&null!=iN(r)&&E!==O&&s.reference[f]/2-(E<C?C:A)-g[f]/2<0,T=D?E<C?E-C:E-S:0;return{[b]:u[b]+T,data:{[b]:O,centerOffset:E-O-T,...D&&{alignmentOffset:T}},reset:D}}}),o_=(e,t,i)=>{let o=new Map,r={platform:om,...i},s={...r.platform,_c:o};return iV(e,t,{...r,platform:s})},ox=e=>(...t)=>({_$litDirective$:e,values:t});let directive_i=class directive_i{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};let o$=ox(class extends directive_i{constructor(e){if(super(e),1!==e.type||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this.st){for(let i in this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e))),t)t[i]&&!this.nt?.has(i)&&this.st.add(i);return this.render(t)}let i=e.element.classList;for(let e of this.st)e in t||(i.remove(e),this.st.delete(e));for(let e in t){let o=!!t[e];o===this.st.has(e)||this.nt?.has(e)||(o?(i.add(e),this.st.add(e)):(i.remove(e),this.st.delete(e)))}return ey}});function ok(e){var t=e;for(let e=t;e;e=oP(e))if(e instanceof Element&&"none"===getComputedStyle(e).display)return null;for(let e=oP(t);e;e=oP(e)){if(!(e instanceof Element))continue;let t=getComputedStyle(e);if("contents"!==t.display&&("static"!==t.position||i6(t)||"BODY"===e.tagName))return e}return null}function oP(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}var oC=class extends iS{constructor(){super(...arguments),this.localize=new iC(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),i=this.placement.includes("top")||this.placement.includes("bottom"),o=0,r=0,s=0,a=0,l=0,c=0,d=0,h=0;i?e.top<t.top?(o=e.left,r=e.bottom,s=e.right,a=e.bottom,l=t.left,c=t.top,d=t.right,h=t.top):(o=t.left,r=t.bottom,s=t.right,a=t.bottom,l=e.left,c=e.top,d=e.right,h=e.top):e.left<t.left?(o=e.right,r=e.top,s=t.left,a=t.top,l=e.right,c=e.bottom,d=t.left,h=t.bottom):(o=t.right,r=t.top,s=e.left,a=e.top,l=t.right,c=t.bottom,d=e.left,h=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${o}px`),this.style.setProperty("--hover-bridge-top-left-y",`${r}px`),this.style.setProperty("--hover-bridge-top-right-x",`${s}px`),this.style.setProperty("--hover-bridge-top-right-y",`${a}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${l}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${c}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${h}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&"string"==typeof this.anchor){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else{var e;this.anchor instanceof Element||null!==(e=this.anchor)&&"object"==typeof e&&"getBoundingClientRect"in e&&(!("contextElement"in e)||e.contextElement instanceof Element)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]')}this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){this.anchorEl&&this.active&&(this.cleanup=function(e,t,i,o){let r;void 0===o&&(o={});let{ancestorScroll:s=!0,ancestorResize:a=!0,elementResize:l="function"==typeof ResizeObserver,layoutShift:c="function"==typeof IntersectionObserver,animationFrame:d=!1}=o,h=os(e),p=s||a?[...h?oi(h):[],...oi(t)]:[];p.forEach(e=>{s&&e.addEventListener("scroll",i,{passive:!0}),a&&e.addEventListener("resize",i)});let u=h&&c?function(e,t){let i,o=null,r=iJ(e);function s(){var e;clearTimeout(i),null==(e=o)||e.disconnect(),o=null}return!function a(l,c){void 0===l&&(l=!1),void 0===c&&(c=1),s();let d=e.getBoundingClientRect(),{left:h,top:p,width:u,height:b}=d;if(l||t(),!u||!b)return;let f=iD(p),g=iD(r.clientWidth-(h+u)),m={rootMargin:-f+"px "+-g+"px "+-iD(r.clientHeight-(p+b))+"px "+-iD(h)+"px",threshold:iz(0,iE(1,c))||1},v=!0;function w(t){let o=t[0].intersectionRatio;if(o!==c){if(!v)return a();o?a(!1,o):i=setTimeout(()=>{a(!1,1e-7)},1e3)}1!==o||ov(d,e.getBoundingClientRect())||a(),v=!1}try{o=new IntersectionObserver(w,{...m,root:r.ownerDocument})}catch{o=new IntersectionObserver(w,m)}o.observe(e)}(!0),s}(h,i):null,b=-1,f=null;l&&(f=new ResizeObserver(e=>{let[o]=e;o&&o.target===h&&f&&(f.unobserve(t),cancelAnimationFrame(b),b=requestAnimationFrame(()=>{var e;null==(e=f)||e.observe(t)})),i()}),h&&!d&&f.observe(h),f.observe(t));let g=d?oc(e):null;return d&&function t(){let o=oc(e);g&&!ov(g,o)&&i(),g=o,r=requestAnimationFrame(t)}(),i(),()=>{var e;p.forEach(e=>{s&&e.removeEventListener("scroll",i),a&&e.removeEventListener("resize",i)}),null==u||u(),null==(e=f)||e.disconnect(),f=null,d&&cancelAnimationFrame(r)}}(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){var e,t,i;if(!this.active||!this.anchorEl)return;let o=[{name:"offset",options:e={mainAxis:this.distance,crossAxis:this.skidding},async fn(t){var i,o;let{x:r,y:s,placement:a,middlewareData:l}=t,c=await iK(t,e);return a===(null==(i=l.offset)?void 0:i.placement)&&null!=(o=l.arrow)&&o.alignmentOffset?{}:{x:r+c.x,y:s+c.y,data:{...c,placement:a}}}}];this.sync?o.push(oy({apply:({rects:e})=>{let t="width"===this.sync||"both"===this.sync,i="height"===this.sync||"both"===this.sync;this.popup.style.width=t?`${e.reference.width}px`:"",this.popup.style.height=i?`${e.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&o.push({name:"flip",options:t={boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:"best-fit"===this.flipFallbackStrategy?"bestFit":"initialPlacement",padding:this.flipPadding},async fn(e){var i,o,r,s,a;let{placement:l,middlewareData:c,rects:d,initialPlacement:h,platform:p,elements:u}=e,{mainAxis:b=!0,crossAxis:f=!0,fallbackPlacements:g,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:v="none",flipAlignment:w=!0,..._}=iM(t,e);if(null!=(i=c.arrow)&&i.alignmentOffset)return{};let x=iB(l),$=iF(h),P=iB(h)===h,C=await (null==p.isRTL?void 0:p.isRTL(u.floating)),A=g||(P||!w?[iH(h)]:function(e){let t=iH(e);return[iI(e),t,iI(t)]}(h)),S="none"!==v;!g&&S&&A.push(...function(e,t,i,o){let r=iN(e),s=function(e,t,i){let o=["left","right"],r=["right","left"];switch(e){case"top":case"bottom":if(i)return t?r:o;return t?o:r;case"left":case"right":return t?["top","bottom"]:["bottom","top"];default:return[]}}(iB(e),"start"===i,o);return r&&(s=s.map(e=>e+"-"+r),t&&(s=s.concat(s.map(iI)))),s}(h,w,v,C));let E=[h,...A],O=await iY(e,_),D=[],T=(null==(o=c.flip)?void 0:o.overflows)||[];if(b&&D.push(O[x]),f){let e=function(e,t,i){void 0===i&&(i=!1);let o=iN(e),r=iU(iF(e)),s=ij(r),a="x"===r?o===(i?"end":"start")?"right":"left":"start"===o?"bottom":"top";return t.reference[s]>t.floating[s]&&(a=iH(a)),[a,iH(a)]}(l,d,C);D.push(O[e[0]],O[e[1]])}if(T=[...T,{placement:l,overflows:D}],!D.every(e=>e<=0)){let e=((null==(r=c.flip)?void 0:r.index)||0)+1,t=E[e];if(t)return{data:{index:e,overflows:T},reset:{placement:t}};let i=null==(s=T.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0])?void 0:s.placement;if(!i)switch(m){case"bestFit":{let e=null==(a=T.filter(e=>{if(S){let t=iF(e.placement);return t===$||"y"===t}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0])?void 0:a[0];e&&(i=e);break}case"initialPlacement":i=h}if(l!==i)return{reset:{placement:i}}}return{}}}),this.shift&&o.push({name:"shift",options:i={boundary:this.shiftBoundary,padding:this.shiftPadding},async fn(e){let{x:t,y:o,placement:r}=e,{mainAxis:s=!0,crossAxis:a=!1,limiter:l={fn:e=>{let{x:t,y:i}=e;return{x:t,y:i}}},...c}=iM(i,e),d={x:t,y:o},h=await iY(e,c),p=iF(iB(r)),u=iU(p),b=d[u],f=d[p];if(s){let e="y"===u?"top":"left",t="y"===u?"bottom":"right",i=b+h[e],o=b-h[t];b=iz(i,iE(b,o))}if(a){let e="y"===p?"top":"left",t="y"===p?"bottom":"right",i=f+h[e],o=f-h[t];f=iz(i,iE(f,o))}let g=l.fn({...e,[u]:b,[p]:f});return{...g,data:{x:g.x-t,y:g.y-o,enabled:{[u]:s,[p]:a}}}}}),this.autoSize?o.push(oy({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{"vertical"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-height",`${t}px`):this.style.removeProperty("--auto-size-available-height"),"horizontal"===this.autoSize||"both"===this.autoSize?this.style.setProperty("--auto-size-available-width",`${e}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&o.push(ow({element:this.arrowEl,padding:this.arrowPadding}));let r="absolute"===this.strategy?e=>om.getOffsetParent(e,ok):om.getOffsetParent;o_(this.anchorEl,this.popup,{placement:this.placement,middleware:o,strategy:this.strategy,platform:io(ii({},om),{getOffsetParent:r})}).then(({x:e,y:t,middlewareData:i,placement:o})=>{let r="rtl"===this.localize.dir(),s={top:"bottom",right:"left",bottom:"top",left:"right"}[o.split("-")[0]];if(this.setAttribute("data-current-placement",o),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=i.arrow.x,t=i.arrow.y,o="",a="",l="",c="";if("start"===this.arrowPlacement){let i="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";o="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",a=r?i:"",c=r?"":i}else if("end"===this.arrowPlacement){let i="number"==typeof e?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";a=r?"":i,c=r?i:"",l="number"==typeof t?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else"center"===this.arrowPlacement?(c="number"==typeof e?"calc(50% - var(--arrow-size-diagonal))":"",o="number"==typeof t?"calc(50% - var(--arrow-size-diagonal))":""):(c="number"==typeof e?`${e}px`:"",o="number"==typeof t?`${t}px`:"");Object.assign(this.arrowEl.style,{top:o,right:a,bottom:l,left:c,[s]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return ev`
    ...
    `}};oD.styles=[iA,ig],oD.dependencies={"sl-popup":oC},ir([eM("slot:not([name])")],oD.prototype,"defaultSlot",2),ir([eM(".tooltip__body")],oD.prototype,"body",2),ir([eM("sl-popup")],oD.prototype,"popup",2),ir([eL()],oD.prototype,"content",2),ir([eL()],oD.prototype,"placement",2),ir([eL({type:Boolean,reflect:!0})],oD.prototype,"disabled",2),ir([eL({type:Number})],oD.prototype,"distance",2),ir([eL({type:Boolean,reflect:!0})],oD.prototype,"open",2),ir([eL({type:Number})],oD.prototype,"skidding",2),ir([eL()],oD.prototype,"trigger",2),ir([eL({type:Boolean})],oD.prototype,"hoist",2),ir([oO("open",{waitUntilFirstUpdate:!0})],oD.prototype,"handleOpenChange",1),ir([oO(["content","distance","hoist","placement","skidding"])],oD.prototype,"handleOptionsChange",1),ir([oO("disabled")],oD.prototype,"handleDisabledChange",1),iu("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}}),iu("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}}),oD.define("sl-tooltip");var oL=Object.defineProperty,oT=Object.getOwnPropertyDescriptor,oR=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?oT(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&oL(t,i,s),s};iu("tooltip.show",null),iu("tooltip.hide",null);let oM=class extends lit_element_i{constructor(){super(...arguments),this.placement="bottom",this.disabled=!1}firstUpdated(){this.observer=new MutationObserver(e=>{for(let t of e)if("attributes"===t.type&&"data-current-placement"===t.attributeName){let e=t.target.getAttribute("data-current-placement");e?this.setAttribute("data-current-placement",e):this.removeAttribute("data-current-placement")}});let e=this.shadowRoot?.querySelector("sl-tooltip")?.shadowRoot;e&&this.observer.observe(e,{attributes:!0,attributeFilter:["data-current-placement"],subtree:!0})}disconnectedCallback(){this.observer?.disconnect(),super.disconnectedCallback()}render(){return ev`<sl-tooltip
			.placement=${this.placement}
			?disabled=${this.disabled}
			.distance=${this.distance??ew}
			hoist
		>
			<slot></slot>
			<div slot="content">
	...
	`,oR([eL()],oM.prototype,"content",2),oR([eL({reflect:!0})],oM.prototype,"placement",2),oR([eL({type:Boolean})],oM.prototype,"disabled",2),oR([eL({type:Number})],oM.prototype,"distance",2),oR([eL({type:Boolean})],oM.prototype,"hoist",2),oM=oR([ez("gl-tooltip")],oM);var oB=Object.defineProperty,oN=Object.getOwnPropertyDescriptor,oU=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?oN(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&oB(t,i,s),s};let oj=class extends lit_element_i{constructor(){super(...arguments),this.disabled=!1,this.full=!1,this.tooltipPlacement="bottom"}connectedCallback(){super.connectedCallback(),this.setAttribute("role",this.href?"link":"button"),this.disabled&&this.setAttribute("aria-disabled",this.disabled.toString())}willUpdate(e){if(e.has("href")&&this.setAttribute("role",this.href?"link":"button"),e.has("disabled")){let t=e.get("disabled");t?this.setAttribute("aria-disabled",t.toString()):this.removeAttribute("aria-disabled")}super.willUpdate(e)}render(){return this.tooltip?ev`<gl-tooltip .content=${this.tooltip} placement=${tY(this.tooltipPlacement)}
				>${this.renderControl()}</gl-tooltip
			>`:this.querySelectorAll('[slot="tooltip"]').length>0?ev`<gl-tooltip placement=${tY(this.tooltipPlacement)}>
				${this.renderControl()}
		...
		>
			<slot name="prefix"></slot><slot class="label"></slot><slot name="suffix"></slot>
		</button>`}onLinkKeypress(e){" "===e.key&&this.control.click()}focus(e){this.control.focus(e)}blur(){this.control.blur()}click(){this.control.click()}};oj.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},oj.styles=[t0,A`
			:host {
		...
		`],oU([eM(".control")],oj.prototype,"control",2),oU([eL({reflect:!0})],oj.prototype,"appearance",2),oU([eL({type:Boolean,reflect:!0})],oj.prototype,"disabled",2),oU([eL({reflect:!0})],oj.prototype,"density",2),oU([eL({type:Boolean,reflect:!0})],oj.prototype,"full",2),oU([eL()],oj.prototype,"href",2),oU([eL()],oj.prototype,"tooltip",2),oU([eL()],oj.prototype,"tooltipPlacement",2),oj=oU([ez("gl-button")],oj);let unsafe_html_e=class unsafe_html_e extends directive_i{constructor(e){if(super(e),this.it=ew,2!==e.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===ew||null==e)return this._t=void 0,this.it=e;if(e===ey)return e;if("string"!=typeof e)throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};unsafe_html_e.directiveName="unsafeHTML",unsafe_html_e.resultType=1;let oF=ox(unsafe_html_e),{I:oI}={M:ee,P:et,A:ei,C:1,L:ek,R:M,D:el,V:eP,I:R,H:k,N:I,U:L,B:H,F:z},oH=e=>null===e||"object"!=typeof e&&"function"!=typeof e,oq=e=>void 0===e.strings,oW=(e,t)=>{let i=e._$AN;if(void 0===i)return!1;for(let e of i)e._$AO?.(t,!1),oW(e,t);return!0},oG=e=>{let t,i;do{if(void 0===(t=e._$AM))break;(i=t._$AN).delete(e),e=t}while(0===i?.size)},oV=e=>{for(let t;t=e._$AM;e=t){let i=t._$AN;if(void 0===i)t._$AN=i=new Set;else if(i.has(e))break;i.add(e),oZ(t)}};function oY(e){void 0!==this._$AN?(oG(this),this._$AM=e,oV(this)):this._$AM=e}function oK(e,t=!1,i=0){let o=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(t)if(Array.isArray(o))for(let e=i;e<o.length;e++)oW(o[e],!1),oG(o[e]);else null!=o&&(oW(o,!1),oG(o));else oW(this,e)}let oZ=e=>{2==e.type&&(e._$AP??=oK,e._$AQ??=oY)};let async_directive_f=class async_directive_f extends directive_i{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,i){super._$AT(e,t,i),oV(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(oW(this,e),oG(this))}setValue(e){if(oq(this._$Ct))this._$Ct._$AI(e,this);else{let t=[...this._$Ct._$AH];t[this._$Ci]=e,this._$Ct._$AI(t,this,0)}}disconnected(){}reconnected(){}};let private_async_helpers_s=class private_async_helpers_s{constructor(e){this.G=e}disconnect(){this.G=void 0}reconnect(e){this.G=e}deref(){return this.G}};let private_async_helpers_i=class private_async_helpers_i{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){this.Y??=new Promise(e=>this.Z=e)}resume(){this.Z?.(),this.Y=this.Z=void 0}};let oX=e=>!oH(e)&&"function"==typeof e.then;let until_c=class until_c extends async_directive_f{constructor(){super(...arguments),this._$Cwt=0x3fffffff,this._$Cbt=[],this._$CK=new private_async_helpers_s(this),this._$CX=new private_async_helpers_i}render(...e){return e.find(e=>!oX(e))??ey}update(e,t){let i=this._$Cbt,o=i.length;this._$Cbt=t;let r=this._$CK,s=this._$CX;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this._$Cwt);e++){let a=t[e];if(!oX(a))return this._$Cwt=e,a;e<o&&a===i[e]||(this._$Cwt=0x3fffffff,o=0,Promise.resolve(a).then(async e=>{for(;s.get();)await s.get();let t=r.deref();if(void 0!==t){let i=t._$Cbt.indexOf(a);i>-1&&i<t._$Cwt&&(t._$Cwt=i,t.setValue(e))}}))}return ey}disconnected(){this._$CK.disconnect(),this._$CX.pause()}reconnected(){this._$CK.reconnect(this),this._$CX.resume()}};let oQ=ox(until_c);var oJ=Object.defineProperty,o0=Object.getOwnPropertyDescriptor,o1=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?o0(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&oJ(t,i,s),s};let o2=class extends lit_element_i{constructor(){super(...arguments),this.type="info",this._hasPromo=!1}get hasPromo(){return this._hasPromo}set hasPromo(e){this._hasPromo=e}render(){return ev`${oQ(this.promoPromise.then(e=>this.renderPromo(e)),ew)}`}renderPromo(e){if(!e?.content?.webview){this.hasPromo=!1;return}let t=e.content.webview;switch(this.type){case"info":if(t.info)return this.hasPromo=!0,ev`<p class="promo" part="text">${oF(t.info.html)}</p>`;break;case"link":if(t.link)return this.hasPromo=!0,ev`<a
						class="link"
						part="link"
						href="${this.getCommandUrl(e)}"
						title="${tY(t.link.title)}"
						>${oF(t.link.html)}</a
					>`}return this.hasPromo=!1,ew}getCommandUrl(e){let t;return e?.content?.webview?.link?.command?.startsWith("command:")&&(t=e.content.webview.link.command.substring(8)),tK(t??"gitlens.plus.upgrade",this.source)}focus(){this._focusable?.focus()}};o2.shadowRootOptions={...lit_element_i.shadowRootOptions,delegatesFocus:!0},o2.styles=[A`
			:host {
				display: block;
			}
		...
		`],o1([eM('a,button,[tabindex="0"]')],o2.prototype,"_focusable",2),o1([eL({type:Object})],o2.prototype,"promoPromise",2),o1([eL({type:Object})],o2.prototype,"source",2),o1([eL({reflect:!0,type:String})],o2.prototype,"type",2),o1([eL({type:Boolean,reflect:!0,attribute:"has-promo"})],o2.prototype,"hasPromo",1),o2=o1([ez("gl-promo")],o2);var o8=Object.defineProperty,o5=Object.getOwnPropertyDescriptor,o9=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?o5(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&o8(t,i,s),s};let o6=class extends lit_element_i{firstUpdated(){"alert"===this.appearance&&queueMicrotask(()=>this.button.focus())}render(){let e=null==this.state;if(this.hidden=e,e)return;let t=(this.appearance??"alert")==="alert"?"alert":void 0;switch(this.state){case eN.VerificationRequired:return ev`
				...
				`;case eN.Community:case eN.ProPreviewExpired:if(this.featurePreview&&"expired"!==function(e){let t=e?.usages;if(!t?.length)return"eligible";let i=(new Date(t[t.length-1].expiresOn).getTime()-new Date().getTime())/36e5;return t.length<=3&&i>0&&i<24?"active":"expired"}(this.featurePreview))return ev`${this.renderFeaturePreview(this.featurePreview)}`;return ev`<slot name="feature"></slot>
					<p>
					...
					</p>`;case eN.ProTrialExpired:return ev`<slot name="feature"></slot>
					...
					<p>${this.renderPromo()}</p>`;case eN.ProTrialReactivationEligible:return ev`<slot name="feature"></slot>
					<p class="actions-row">
						<gl-button
							class="inline"
							appearance="${tY(t)}"
		...
		`],o9([eM("gl-button")],o6.prototype,"button",2),o9([eL({type:Object})],o6.prototype,"featurePreview",2),o9([eL({type:String})],o6.prototype,"featurePreviewCommandLink",2),o9([eL({type:String})],o6.prototype,"appearance",2),o9([eL()],o6.prototype,"featureWithArticleIfNeeded",2),o9([e9({context:"promos"})],o6.prototype,"promos",2),o9([eL({type:Object})],o6.prototype,"source",2),o9([eL({attribute:!1,type:Number})],o6.prototype,"state",2),o9([eL({type:String})],o6.prototype,"webroot",2),o6=o9([ez("gl-feature-gate-plus-state")],o6);var o3=Object.defineProperty,o7=Object.getOwnPropertyDescriptor,o4=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?o7(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&o3(t,i,s),s};let re=class extends lit_element_i{render(){var e;let t=!this.visible||null!=this.state&&null!=(e=this.state)&&(e===eN.Paid||e===eN.ProPreview||e===eN.ProTrial);if(this.hidden=t,t)return;let i=this.appearance??(document.body.getAttribute("data-placement")??"editor")==="editor"?"alert":"welcome";return ev`
			<section>
				<slot></slot>
		...
		`],ro([eM("#popover")],rr.prototype,"body",2),ro([eM("sl-popup")],rr.prototype,"popup",2),ro([eL({reflect:!0})],rr.prototype,"placement",2),ro([eL({type:Object})],rr.prototype,"anchor",2),ro([eL({reflect:!0,type:Boolean})],rr.prototype,"disabled",2),ro([eL({type:Number})],rr.prototype,"distance",2),ro([eL({reflect:!0,type:Boolean})],rr.prototype,"open",2),ro([eL({reflect:!0,type:Boolean})],rr.prototype,"arrow",2),ro([eL({type:Number})],rr.prototype,"skidding",2),ro([eL()],rr.prototype,"trigger",2),ro([eL({type:Boolean})],rr.prototype,"hoist",2),ro([e3("open",{afterFirstUpdate:!0})],rr.prototype,"handleOpenChange",1),ro([e3(["distance","hoist","placement","skidding"])],rr.prototype,"handleOptionsChange",1),ro([e3("disabled")],rr.prototype,"handleDisabledChange",1),rr=ro([ez("gl-popover")],rr);var rs=Object.defineProperty,rn=Object.getOwnPropertyDescriptor,ra=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?rn(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&rs(t,i,s),s};let rl=class extends lit_element_i{constructor(){super(...arguments),this.cloud=!1,this.placement="bottom",this.preview=!1}get daysRemaining(){var e,t,i,o;if(null==this.subscription)return 0;return e=this.subscription,t="days",i=e.plan.effective.expiresOn,o=t,(null!=i?function(e,t,i,o){let r=("number"==typeof t?t:t.getTime())-("number"==typeof e?e:e.getTime()),s=o??Math.floor;switch(i){case"days":return s(r/864e5);case"hours":return s(r/36e5);case"minutes":return s(r/6e4);case"seconds":return s(r/1e3);default:return r}}(Date.now(),new Date(i),o,Math.round):void 0)??0}get state(){return this.subscription?.state}render(){return ev`
		...
		`}renderBadge(){let e=this.preview?"Preview":"Pro";if(null!=this.subscription)if(this.state===eN.VerificationRequired)return ev`${e} <code-icon class="badge-icon" icon="warning" size="10"></code-icon>`;else{var t;if(eV(this.subscription)||this.cloud&&null!=this.subscription.account)return ev`${e} <code-icon class="badge-icon" icon="check" size="10"></code-icon>`;if(null!=(t=this.state)&&(t===eN.ProPreview||t===eN.ProTrial))return ev`${e} <code-icon class="badge-icon" icon="clock" size="10"></code-icon>`}return e}renderPopoverHeader(){let e=ev`<span class="popup-title">${this.preview?"Preview feature":"Pro feature"}</span>`;return this.state===eN.Paid?ev`<div class="popup-header">${e}</div>`:this.cloud?this.preview?ev`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires GitLens Pro for use on privately-hosted repos</span>
		</div>`}renderPopoverContent(){let e;if(null==this.subscription)return ew;switch(this.state){case eN.Paid:var t;e=ev`<p>
					Your
				...
				</p>`;break;case eN.VerificationRequired:e=ev`<p>You must verify your email before you can access Pro features.</p>
					<div class="actions">
						<gl-button
							density="tight"
							href="${tK("gitlens.plus.resendVerification",this.source)}"
						...
						<gl-button
							...
							><code-icon icon="refresh"></code-icon
						></gl-button>
					</div>`;break;case eN.ProTrial:{let t=this.daysRemaining;e=ev`<p>
						You have
						<strong>${t<1?"<1 day":tf("day",t,{infix:" more "})} left</strong>
						in your Pro trial. Once your trial ends, you will only be able to use Pro features on
						publicly-hosted repos.
					</p>
					${this.renderUpgradeActions()}`;break}case eN.ProTrialExpired:e=ev`<p>
						Your Pro trial has ended. You can now only use Pro features on publicly-hosted repos.
					</p>
					${this.renderUpgradeActions(ev`<p>Please upgrade for full access to all GitLens Pro features:</p>`)}`;break;case eN.ProTrialReactivationEligible:e=ev`<p>
					...
					<div class="actions center">
						...
						>
					</div>`;break;default:if(!this.cloud&&this.state===eN.ProPreview){let t=this.daysRemaining;e=ev`<p>
							You have
							<strong>${t<1?"<1 day":tf("day",t,{infix:" more "})} left</strong>
							to preview
						...
						${this.renderStartTrialActions()}`;break}e=ev`<p>
					...
					${this.renderStartTrialActions()}`}return ev`<div class="popup-content">${e}</div>`}renderStartTrialActions(){return ev`<div class="actions">
			...
			&nbsp;or
			<a href="${tK("gitlens.plus.login",this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return ev`<div class="actions">
			${e??ew}
			<gl-button
				density="tight"
	...
	`,ru([eL({reflect:!0})],rf.prototype,"icon",2),ru([eL({reflect:!0})],rf.prototype,"modifier",2),ru([eL({type:Number})],rf.prototype,"size",2),ru([eL({reflect:!0})],rf.prototype,"flip",2),ru([eL({reflect:!0})],rf.prototype,"rotate",2),rf=ru([ez("code-icon")],rf);var rg=Object.defineProperty,rm=Object.getOwnPropertyDescriptor,rv=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?rm(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&rg(t,i,s),s};let ry=class extends lit_element_i{constructor(){super(...arguments),this.mode="infinite",this.active=!1,this.position="bottom"}firstUpdated(){this.setAttribute("role","progressbar")}render(){return ev`<div class="progress-bar"></div>`}};ry.styles=A`
		* {
			box-sizing: border-box;
		}
	...
	`,rv([eL({reflect:!0})],ry.prototype,"mode",2),rv([eL({type:Boolean})],ry.prototype,"active",2),rv([eL()],ry.prototype,"position",2),ry=rv([ez("progress-indicator")],ry);var rw=Object.defineProperty,r_=Object.getOwnPropertyDescriptor,rx=(e,t,i,o)=>{for(var r,s=o>1?void 0:o?r_(t,i):t,a=e.length-1;a>=0;a--)(r=e[a])&&(s=(o?r(t,i,s):r(s))||s);return o&&s&&rw(t,i,s),s};let r$=class extends GlApp{constructor(){super(...arguments),this._loading=!0,this._zoomed=!1,this.onDocumentKeyDown=e=>{("Escape"===e.key||"Esc"===e.key)&&this._chart?.reset()}}createStateProvider(e,t){return new TimelineStateProvider(this,e,t)}onPersistState(e){this._ipc.setPersistedState({period:e.period,uri:e.uri})}connectedCallback(){super.connectedCallback(),document.addEventListener("keydown",this.onDocumentKeyDown)}disconnectedCallback(){document.removeEventListener("keydown",this.onDocumentKeyDown),super.disconnectedCallback()}get allowed(){return this.state.access?.allowed??!1}get header(){let e,t=this.state.title;if(null!=t){let i=t.lastIndexOf("/");if(i>=0){let o=t.substring(i+1);e=t.substring(0,i),t=o}}return{title:t??"",description:e??""}}get loading(){return null!=this.state.dataset&&null!=this.uri&&this._loading}get period(){return this.state.period}get subscription(){return this.state.access?.subscription?.current}get sha(){return this.state.sha}get uri(){return this.state.uri}get uriType(){return this.state.uriType}get zoomed(){return this._zoomed}willUpdate(e){e.has("_loading")||e.has("_zoomed")||(this._loading=!!(this.state.dataset&&this.uri)),super.willUpdate(e)}render(){return ev`
				...
				<header class="header" ?hidden=${!this.uri}>
					<span class="details">
						...
						<span class="details__sha">
							${this.sha?ev`<code-icon icon="git-commit" size="16"></code-icon
										><span class="sha">${this.sha}</span>`:ew}
						</span>
					</span>
					<span class="toolbox">
						${this.zoomed?ev`<gl-button
									appearance="toolbar"
						...
						${"view"===this.placement?ev`<gl-button
									appearance="toolbar"
						...
						${null==this.subscription||!eV(this.subscription)?ev`<gl-feature-badge
									placement="bottom"
		...
		`}renderChart(){return this.uri&&this.state.dataset?ev`<gl-timeline-chart
			id="chart"
			placement="${this.placement}"
